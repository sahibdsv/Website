...
- **Cache Busting**: To force browsers to load the latest changes, the `index.html` file uses a version query parameter (e.g., `?v=2.45`) for `style.css`, `script.js`, and all internal media assets.
